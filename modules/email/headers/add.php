<?php
/**
 * AbroadWorks Management System - Add Email Header
 *
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-plus-circle"></i> Add Email Header</h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <form id="headerForm">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="headerCode" name="code" required pattern="[a-z0-9_]+" placeholder="e.g., default_header">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="headerName" name="name" required placeholder="Header display name">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="headerContent">Content (HTML) <span class="text-danger">*</span></label>
                                    <textarea class="form-control" id="headerContent" name="content" rows="15" required></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="headerDescription" name="description" placeholder="Brief description of this header">
                                </div>
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="headerActive" name="is_active" checked>
...
$(document).ready(function() {
    $('#headerContent').summernote({
        height: 350,
        placeholder: 'Write your header HTML here...',
        toolbar: [
            ['style', ['style']],
...
function saveHeader() {
    ...
    $.ajax({
        ...
        error: function() {
            showAlert('danger', 'Failed to save header');
        }
    });
}
