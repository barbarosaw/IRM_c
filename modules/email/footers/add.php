<?php
/**
 * AbroadWorks Management System - Add Email Footer
 *
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-plus-circle"></i> Add Email Footer</h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <form id="footerForm">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="footerCode" name="code" required pattern="[a-z0-9_]+" placeholder="e.g., default_footer">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="footerName" name="name" required placeholder="Footer display name">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="footerContent">Content (HTML) <span class="text-danger">*</span></label>
                                    <textarea class="form-control" id="footerContent" name="content" rows="15" required></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="footerDescription" name="description" placeholder="Brief description of this footer">
                                </div>
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="footerActive" name="is_active" checked>
...
function saveFooter() {
    ...
    $.ajax({
        ...
        error: function() {
            showAlert('danger', 'Failed to save footer');
        }
    });
}
