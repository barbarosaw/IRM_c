<?php
/**
 * AbroadWorks Management System - Edit Email Template
 *
            ...
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="templateCode" name="code" required pattern="[a-z0-9_]+" value="<?= htmlspecialchars($template['code']) ?>">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="templateName" name="name" required value="<?= htmlspecialchars($template['name']) ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="templateSubject">Subject <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="templateSubject" name="subject" required value="<?= htmlspecialchars($template['subject']) ?>">
                                </div>
                                <div class="form-group">
                                    <label for="templateBody">Body (HTML) <span class="text-danger">*</span></label>
                                    <textarea class="form-control" id="templateBody" name="body" rows="15" required><?= htmlspecialchars($template['body']) ?></textarea>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="templateHeader" name="header_id">
                                                ...
                                                <option value="<?= $header['id'] ?>" <?= ($template['header_id'] ?? '') == $header['id'] ? 'selected' : '' ?>><?= htmlspecialchars($header['name']) ?> (<?= $header['code'] ?>)</option>
                                                <?php endforeach; ?>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="templateFooter" name="footer_id">
                                                ...
                                                <option value="<?= $footer['id'] ?>" <?= ($template['footer_id'] ?? '') == $footer['id'] ? 'selected' : '' ?>><?= htmlspecialchars($footer['name']) ?> (<?= $footer['code'] ?>)</option>
                                                <?php endforeach; ?>
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="templatePlaceholders" name="placeholders" value="<?= htmlspecialchars($template['placeholders'] ?? '') ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="templateDescription" name="description" value="<?= htmlspecialchars($template['description'] ?? '') ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="templateActive" name="is_active" <?= $template['is_active'] ? 'checked' : '' ?>>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="card card-secondary card-outline">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-info"></i> Template Info</h3>
                        </div>
                        <div class="card-body" style="font-size: 0.85rem;">
                            <p><strong>ID:</strong> <?= $template['id'] ?></p>
                            <p><strong>Code:</strong> <code><?= htmlspecialchars($template['code']) ?></code></p>
                            <?php if (!empty($template['created_at'])): ?>
                            <p><strong>Created:</strong> <?= date('M d, Y H:i', strtotime($template['created_at'])) ?></p>
                            <?php endif; ?>
                            <?php if (!empty($template['updated_at'])): ?>
                            <p><strong>Updated:</strong> <?= date('M d, Y H:i', strtotime($template['updated_at'])) ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
