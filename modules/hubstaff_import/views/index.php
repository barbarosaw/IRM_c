<?php
/**
 * Hubstaff Import Module - Main View
 */

$exportsDir = __DIR__ . '/../exports';
$stateFile = $exportsDir . '/state.json';
...
foreach ($files as $file) {
    ...
    $name = str_replace('_december_2025.csv', '', $filename);
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-primary">Hubstaff Import</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="../../index.php">Home</a></li>
                        <li class="breadcrumb-item active">Hubstaff Import</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="mb-3">
                ...
                <a href="november.php" class="btn btn-outline-secondary">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">December 2025 Timesheet Export</h3>
                </div>
                <div class="card-body">
...
document.getElementById('btnDownloadAll')?.addEventListener('click', function() {
    window.location.href = 'download_zip.php';
});
...
document.querySelectorAll('.btn-delete').forEach(btn => {
    btn.addEventListener('click', function() {
        ...
        fetch('delete_export.php?file=' + encodeURIComponent(file))
            .then(response => response.json())
            .then(data => {
                if (data.success) {
                    location.reload();
...
document.querySelectorAll('.btn-view').forEach(btn => {
    btn.addEventListener('click', function() {
        ...
        document.querySelector('#viewModal .modal-title').textContent = file.replace('_december_2025.csv', '').replace(/_/g, ' ').toUpperCase();
        loading.style.display = 'block';
        content.style.display = 'none';
        modal.show();

        fetch('view_csv.php?file=' + encodeURIComponent(file))
            .then(response => response.json())
            .then(data => {
...
<?php if ($isProcessing): ?>
setTimeout(() => {
    fetch('import.php?mode=continue')
        .then(response => response.json())
        .then(data => {
            if (data.continue) {
                setTimeout(() => location.reload(), 2000);
