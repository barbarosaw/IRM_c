...
$usersFile = $exportsDir . '/users.json';
...
function exportUserData($api, $orgId, $orgName, $userId, $userName, $userTimezone, $projects, $tasks, $exportsDir) {
    ...
    $allActivities = [];
    $weeks = [
        ['2025-12-01T00:00:00Z', '2025-12-07T23:59:59Z'],
        ['2025-12-08T00:00:00Z', '2025-12-14T23:59:59Z'],
        ['2025-12-15T00:00:00Z', '2025-12-21T23:59:59Z'],
        ['2025-12-22T00:00:00Z', '2025-12-28T23:59:59Z'],
        ['2025-12-29T00:00:00Z', '2025-12-31T23:59:59Z']
    ];
    ...
    $csvFile = "$exportsDir/{$safeUserName}_december_2025.csv";
